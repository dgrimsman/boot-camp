...
pts_tri = rename(as.data.frame(bc_poly_tri$P), c('V1'='x', 'V2'='y'))
...
dist_tri = 0
prev_pt = path_tri$vpath[[1]][1]
for (i in 2:length(path_tri$vpath[[1]])){
  pt = path_tri$vpath[[1]][i]
  dist_tri = dist_tri + adj_mat[pt, prev_pt]
  print(adj_mat[pt, prev_pt])
  break
  prev_pt = pt
}
```
